...
## 0.9.0.dev2 - 2026-07-12 (dev pre-release — for online testing, not yet merged)

> Built on top of the `0.8.3` lip-sync fixes + egress/ingress TCP traces
> (`feat/egress_tcp_traces`), merged in.
